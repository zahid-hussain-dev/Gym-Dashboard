...
const index = () => {
    ...
    return (
        <div style={{ marginTop: "10%" }}>
                ...
                <h2 style={{color:"white",marginRight:"40%",marginLeft:"30px"}}> City Listing</h2>
      ...
      {showUpdateCitiesModal && <UpdateCities onClose={handleCloseUpdateModal} id={clickedId} stateName={clickedStateName} cityName={clickedName}/>}
            ...
            {role && role === "admin" &&
                <React.Fragment >
                    <Style.TableContainer style={{ marginTop: "5%", filter: showCitiesModal || showUpdateCitiesModal ? 'blur(5px)' : 'none', pointerEvents: showCitiesModal || showUpdateCitiesModal ? 'none' : 'auto',borderBottom:" 2px solid #d5b93b",borderBottom: "2px solid rgb(213, 185, 59)"}}>
                        <Style.TableWrapper >
                            <thead>
                                <Style.TableRow>
